...
func _1602513851_add_organisationsUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1602513851_add_organisations.up.sql", size: 224, mode: os.FileMode(0644), modTime: time.Unix(1603964571, 0)}
...
func _1603198582_add_profile_chat_fieldUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1603198582_add_profile_chat_field.up.sql", size: 45, mode: os.FileMode(0644), modTime: time.Unix(1603964344, 0)}
...
func _1603816533_add_linksDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1603816533_add_links.down.sql", size: 0, mode: os.FileMode(0644), modTime: time.Unix(1603964344, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0xe3, 0xb0, 0xc4, 0x42, 0x98, 0xfc, 0x1c, 0x14, 0x9a, 0xfb, 0xf4, 0xc8, 0x99, 0x6f, 0xb9, 0x24, 0x27, 0xae, 0x41, 0xe4, 0x64, 0x9b, 0x93, 0x4c, 0xa4, 0x95, 0x99, 0x1b, 0x78, 0x52, 0xb8, 0x55}}
	return a, nil
}
...
func _1603816533_add_linksUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1603816533_add_links.up.sql", size: 48, mode: os.FileMode(0644), modTime: time.Unix(1603964344, 0)}
